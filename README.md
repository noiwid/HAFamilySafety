...
title: Family Safety
entities:
  - entity: sensor.firstname_screen_time
    name: Screen Time
  - entity: sensor.firstname_pending_requests
    name: Pending Requests
  - entity: sensor.firstname_web_filter
    name: Web Filter
  - type: divider
  - entity: number.firstname_monday_limit
    name: Monday Limit
  - entity: number.firstname_tuesday_limit
    name: Tuesday Limit
```
