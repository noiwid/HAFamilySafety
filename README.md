  ...
  - alias: "Lock account at 21:00"
    ...
    action:
      - action: switch.turn_on
        target:
          entity_id: switch.firstname_lastname_lock
  ...
  - alias: "Screen time limit alert"
    trigger:
      - platform: numeric_state
        entity_id: sensor.firstname_lastname_screen_time
        above: 120
    action:
      - action: notify.mobile_app_your_phone
        data:
          ...
          message: >
            {{ state_attr('sensor.firstname_lastname_screen_time', 'formatted_time') }}
...
title: Family Safety
entities:
  - entity: switch.firstname_lastname_lock
    name: Account Lock
  - type: divider
  - entity: sensor.firstname_lastname_screen_time
    name: Screen Time
  - entity: sensor.firstname_lastname_pending_requests
    name: Pending Requests
  - entity: sensor.firstname_lastname_web_filter
    name: Web Filter
  - type: divider
  - entity: number.firstname_lastname_monday_limit
    name: Monday Limit
  - entity: number.firstname_lastname_tuesday_limit
    name: Tuesday Limit
```
